...
const ContactUs = () => {
  ...
  const contactInfoText =
    'New Career College offers industry-focused education, practical training, and career-ready programs to empower students with skills for success in various professional fields.';
